...
(function () {
  'use strict';
  var CFG = {"list": "devon-korea", "lang": "ko", "brand": "DEVON KOREA", "storageKey": "devonKoreaSubscribed", "triggerTexts": ["구독하기", "정기구독"], "modalTitle": {"ko": "데본 코리아 뉴스레터 구독"}, "endpoint": "/api/subscribe"};
  var T = {
