...
const SITE_KEY = 'devon-korea';           // value the page sends as "list"
const LIST_NAME = 'Devon Korea';         // Brevo list name (looked up if no id is configured)
const LIST_ID = 5;               // Brevo list id (null => BREVO_LIST_ID env or lookup by name)
